...
int main(void)
{
	...
	window = glfwCreateWindow(resX, resY, "MXP3D", NULL, NULL);
	if (window == NULL) {
	...
	GLuint programID = LoadShaders("shaders/normalMappingShader.vert", "shaders/normalMappingShader.frag");
	...
	GLuint NormalTexture = loadBMP_custom("textures/normal.bmp");
