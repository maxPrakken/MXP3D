...
int main( void )
{
	...
	glfwWindowHint(GLFW_SAMPLES, 4); //say how many AA you want to use
	...
	do{
		...
		glm::mat4 mvp = getProjectionMatrix() * getViewMatrix() * Model; // Remember, matrix multiplication is the other way around
